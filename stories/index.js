...
storiesOf("Button", module)
  ...
  storiesOf("InterviewerList", module)
    ...
    .add("Header", () => <Header time="12pm" />) //header component
    .add("Empty", () => <Empty onAdd={action("onAdd")} />) //empty component
    .add("Show", () => <Show onEdit={action("onEdit")} onDelete={action("onDelete")} interviewer={interviewers[0]}/>)
    .add("Confirm", () => (
    <Confirm 
